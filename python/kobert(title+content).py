...
torch.save(model.state_dict(), PATH + 'model_tc.pt')
...
model.load_state_dict(torch.load("/content/drive/My Drive/model_tc.pt"))
...
news.to_csv('/content/drive/My Drive/koBERT2.csv', index=False)
