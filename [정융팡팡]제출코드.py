# -*- coding: utf-8 -*-
"""koBERT(title+content).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CUK_0ZGQmn4W2j0RvqCMgSeT5nSp3c2d
...
torch.save(model.state_dict(), PATH + '[최종]kober_model.pt')
#model_tc = torch.load(PATH + '[최종]kober_model.pt')  # 전체 모델을 통째로 불러옴, 클래스 선언 필수
...
import pandas as pd
news = pd.read_csv('/content/drive/My Drive/news_test.csv', encoding = 'utf-8-sig')
...
model.load_state_dict(torch.load("/content/drive/My Drive/[최종]kober_model.pt"))
...
news.to_csv('/content/drive/My Drive/[최종]kober_model.csv', index=False)
